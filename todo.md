...
### §24.21 i18n — Phase 15
- [ ] String externalisation across UI (File Explorer failure text, locale-aware date-token ratchets, locale-bound property date pickers, and native asset view strings shipped; remaining broad audit stays open)
