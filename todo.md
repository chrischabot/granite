...
- [ ] Full live-preview decoration replacement (table cells, nested/block-level marker cases, escaped marker handling, multi-backtick code spans, custom task markers, nested bold-inside-asterisk-italic, nested asterisk-italic-inside-bold, nested underscore-italic-inside-underscore-bold, and nested underscore-bold-inside-underscore-italic ratchets shipped; DOM-level CodeMirror rendering ratchet shipped 2026-05-13; browser verification remains)
