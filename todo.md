...
- [ ] Full live-preview decoration replacement (table cells, nested/block-level marker cases, escaped marker handling, multi-backtick code spans, custom task markers, nested bold-inside-asterisk-italic, and nested asterisk-italic-inside-bold ratchets shipped; DOM-level CodeMirror rendering ratchet shipped 2026-05-13; browser verification remains)
