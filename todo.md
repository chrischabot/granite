...
- [ ] Full keyboard-only audit (workspace tablist, shared menu, Bookmarks add-menu keyboard, and clickable-icon focus-ring ratchets shipped; full browser flow audit remains)
