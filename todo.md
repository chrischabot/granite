...
- [ ] Full live-preview decoration replacement (table cells plus nested/block-level marker cases shipped 2026-05-12; DOM-level CodeMirror rendering ratchet shipped 2026-05-13; browser verification remains)
...
- [ ] 10 k-note cold start < 3 s (10k Node metadata budget ratchet and no-restat guard shipped; browser/profile verification remains)
...
- [ ] Full keyboard-only audit (workspace tablist, shared menu, and Bookmarks add-menu keyboard ratchets shipped; full browser flow audit remains)
...
### §24.21 i18n — Phase 15
- [ ] String externalisation across UI (File Explorer failure text, locale-aware date-token ratchets, and locale-bound property date pickers shipped; remaining broad audit stays open)
