...
- [ ] Full keyboard-only audit (workspace tablist and shared menu keyboard ratchets shipped; full browser flow audit remains)
...
### §24.21 i18n — Phase 15
- [ ] String externalisation across UI (File Explorer trash and filesystem-adapter failure text ratchets shipped; remaining broad audit stays open)
